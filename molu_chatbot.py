...
class DataConfig:
    zip_path: str
    pairing_mode: str = "next_sentence"
    text_field: str = "form"
    min_len: int = 1
    max_len: int = 160
    shuffle: bool = True
...
def train_model(
    ...
    for epoch in range(1, train_cfg.epochs + 1):
        ...
        val_loss, val_tokens = evaluate(model, val_loader, device, autocast_ctx)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    train_parser.add_argument("--pairing_mode", choices=["next_sentence", "turn_change"], default="next_sentence")
